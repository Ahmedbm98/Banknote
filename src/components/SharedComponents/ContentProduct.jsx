function ContentProduct({ productContent }) {
  const { titlePrd, price } = productContent;
  return (
    <div className="content-product ">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-2 justify-between ">
          ...
          <button className="bg-transparent border border-[#C39C45] rounded-[4px] text-[#C39C45] font-bold flex items-center gap-[4px] px-[7px] py-[2px]">
            Add
            <svg
              width="19"
              height="19"
