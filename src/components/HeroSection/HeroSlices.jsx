import bgBannerImg from "../../assets/Imgs/HeroSilces/banner.png";
import HeroSwiper from "./HeroSwiper";
function HeroSlices() {
  return (
    <div
      style={{ backgroundImage: `url(${bgBannerImg})` }}
      className=" overflow-hidden bg-cover bg-center pt-[65px] pb-[15px] rounded-[8px] relative h-[500px] flex justify-center items-center "
    >
